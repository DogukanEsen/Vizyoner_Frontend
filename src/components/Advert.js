...
function App() {
    ...
    const filterOptions = ['Tüm İlanlar', 'Staj İlanları', 'İş ilanları', 'Yarışma'];

    const filteredAdvert = advertData.filter((advert) =>
                        ...
                        <div className="bg-white w-2/3 md:w-11/12 rounded-lg shadow-lg hover:shadow-gray-400">
                            ...
                            <div className="col-xs-12 text-xs text-center">
                                <ul className="flex flex-wrap gap-1 justify-center">
                                    <li
                                        key="all"
                                        className={`p-2 font-bold ${filterOption === 'all' ? 'text-blue-600' : ''}`}
                                    ...
                                    <li
                                        key="staj"
                                        className={`p-2 font-bold ${filterOption === 'staj' ? 'text-blue-600' : ''}`}
                                    ...
                                    <li
                                        key="is"
                                        className={`p-2 font-bold ${filterOption === 'is' ? 'text-blue-600' : ''}`}
                                    ...
                                    <li
                                        key="yarisma"
                                        className={`p-2 font-bold ${filterOption === 'yarisma' ? 'text-blue-600' : ''}`}
