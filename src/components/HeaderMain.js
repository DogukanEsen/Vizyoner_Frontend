      ...
      <div className="bg-[#0073b5] p-1" style={headerStyle}>
        <div className="flex justify-between items-center h-18 max-w-[1240px] mx-auto px-4">
          <a href="#">
            <Link to="/anasayfa">
              <img
                src="https://vizyonergenc.com/v2/images/logo2.png"
                width={100}
                alt="Logo"
              />
            </Link>
          ...
          <ul className="flex -ml-10">
            {[
              ...
              { icon: PiBagSimple, label: "İlanlar", link: "/ilanlar1" },
              {
              ...
              {
                icon: BiBadgeCheck,
                label: "İlan Eşleşmelerim",
                link: "/ilan-eslesmelerim",
              },
            ].map((item, index) => (
            ...
            <li className="p-2">
              <a href="#">
                <Link to="https://kok.vizyonergenc.com">
                  <img
                    className="h-10"
                    src="https://vizyonergenc.com/images/kok_logo_beyaz.png"
                    width={40}
                    alt="Image1"
                  />
                </Link>
            ...
            <li className="p-2">
              <a href="#">
                <Link to="https://kalfa.vizyonergenc.com">
                  <img
                    className="h-10"
                    src="https://vizyonergenc.com/images/kalfa_logo_beyaz.png"
                    width={40}
                    alt="Image2"
                  />
                </Link>
