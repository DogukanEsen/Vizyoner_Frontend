      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-7 col-lg-7 content-right-offset margin-bottom-20">
            ...
            <div>
              <p>
                R-Force Genç Yetenek Programımız başlıyor! Kariyerine
                Roketsan’da başlamaya ve Roketsan’ın ayrıcalıklarını keşfetmeye
                hazırsan seni de aramızda görmekten mutluluk duyarız.
              </p>
              ...
              <li>
                ...
                bölümlerinin birinde 3. veya 4. sınıf öğrencisiysen,
              </li>
              ...
              <p>
                Hadi şimdi kariyerin için büyük bir adım at, R-Forcer olma
                fırsatını kaçırma! Alanında en iyilerle eşsiz bir deneyim elde
                etmek için başvurunu bekliyoruz.
              </p>
              <p>
                <br />
              </p>
